...
A local designation applied to an organism found at a location outside of its known range which \textbf{does not} imply that the species causes any ill effects.

\item[NIS]

An acronym for non-indigenous species.
...
\begin{savequote}
You can see the old cities, still everywhere, the bones and bricks go to
dust, but the little pieces of plastic never do. They never adapt
either.
\qauthor{--- Ursula K. LeGuin, \emph{The Dispossessed}}\end{savequote}
