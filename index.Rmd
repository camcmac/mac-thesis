...
## thesis metadata ##
#####################
title: Investigating the role of anthropogenic marine debris in the ecology and biosecurity of global oceans
title-image: figures/placeholder.png
author: Cameron McMains
college: College of Science, Health, Engineering, and Education 
university: Murdoch University
university-logo: templates/hbi_mu_logo.pdf
...
## bibliography path ##
#######################
#original bibliographies to package
bibliography: [bibliography/references.bib, bibliography/additional-references.bib]

#personal bibliographies
#bibliography: [bibliography/intro-ref.bib, bibliography/synth-ref.bib, bibliography/biosec-ref.bib, bibliography/idstudy-ref.bib, bibliography/abm-ref.bib, bibliography/mgmt-ref.bib]
...
use-biblatex: true
bib-latex-options: "style=authoryear, sorting=nyt, backend=biber, maxcitenames=3, useprefix, doi=true, isbn=false, uniquename=false" #for science, you might want style=numeric-comp, sorting=none for numerical in-text citation with references in order of appearance
...
ordinary-page-number-position: R  #C = center, R = right, L = left. If page layout is 'twoside', O = odd pages and E = even pages. E.g. RO,LE puts the page number to the right on odd pages and left on even pages
chapter-page-number-foot-or-head: foot #you may want it to be different on the chapter pages
chapter-page-number-position: R
