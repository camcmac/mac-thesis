...
Numerous other studies have documented shorter-distance travel aboard debris to new locations just outside of a species known range [@citekey; @citekey]. Through short hops from ports areas, seen in @Miralles2014, AMD has shown its potential to expand the spatial extent of incursions in these types of invasion hotspots. The inherently random, omnipresent, and indirect character of AMD which would make these halos difficult to search or monitor for this effect also makes it difficult to implicate it in an introduction with any certainty. However, with the absence of other modes of introduction, known as **introduction vectors**, AMD has been reasonably suggested as the source of a recent spread of the **Mytilus** species complex (containing known invasive species) to a remote island in the Arctic circle [@kotwickiReappearanceMytilusSpp2021]. 

### AMD as a pathway

In the context of marine biosecurity, introduction pathway refers to a way that humans transport species around oceans and seas. **Vectors** are the common trajectories taken by those pathways, such as high-traffic shipping lanes. Some species transported by pathways along vectors are designated by regulatory or management bodies as **invasive species**. This designation is generally given once it has been demonstrated that the species causes significant harm to human and/or natural systems. Invasive species are typically associated with a specific pathway, or set of vectors, known to facilitate their dispersal. AMD could be considered a pathway for each of the hundreds of species known to use it as habitat [@citekey].
