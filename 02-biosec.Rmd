...
```{r materialDefine, echo = F, out.width = params$width, fig.scap = "Material type definitions", fig.cap = "Material type designations used to classify the broader range of materials found in the OAAMD to provide adequate sample sizes in the following statistical analyses."}
